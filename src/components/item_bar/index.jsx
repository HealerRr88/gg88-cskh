...
export default function ItemBarComponent() {
  ...
  return (
    isMobile ? (
      <div className='container mt-3'>
        ...
        >
          <SwiperSlide>
            <Link target='__bank' to={links.find(x => x.key === LINK_KEYS.LIVESTREAM_ME_SAY.key)?.url} className='flex-fill text-center arise-animation'>
              <img className='img-fluid' src={livestream_icon} alt="livestream_icon" />
              <div className={styles.itemBarText}>LIVESTREAM MÊ SAY</div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link target='__bank' to={links.find(x => x.key === LINK_KEYS.LIEN_MINH_KJC.key)?.url} className='flex-fill text-center arise-animation'>
              <img className='img-fluid' src={lien_minh_kjc_icon} alt="lien_minh_kjc_icon" />
              <div className={styles.itemBarText}>LIÊN MINH KJC</div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link target='__bank' to={links.find(x => x.key === LINK_KEYS.QUA_TANG_TRI_AN.key)?.url} className='flex-fill text-center arise-animation'>
          ...
          <SwiperSlide>
            <Link target='__bank' to={links.find(x => x.key === LINK_KEYS.THU_THAP_CHU_CAI.key)?.url} className='flex-fill text-center arise-animation'>
          ...
          <SwiperSlide>
            <Link target='__bank' to={links.find(x => x.key === LINK_KEYS.VONG_QUAY_MAY_MAN.key)?.url} className='flex-fill text-center arise-animation'>
      ...
      <div className={`d-flex justify-content-between align-items-center gap-4 p-3 mt-5 ${styles.itemBar}`}>
        ...
        <Link target='__blank' to={links.find(x => x.key === LINK_KEYS.VONG_QUAY_MAY_MAN.key)?.url} className='flex-fill text-center arise-animation'>
          <img className='img-fluid' src={vong_quay_may_man_icon} alt="vong_quay_may_man_icon" />
