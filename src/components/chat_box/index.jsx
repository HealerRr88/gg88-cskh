  ...
  return (
    <div className="w-100 h-100 d-flex flex-column">
      <div className={`d-flex align-items-center justify-content-end p-md-3 p-2 ${styles.chatBoxHeader}`}>
        <svg width={isMobile ? 20 : 40} height={isMobile ? 20 : 40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='cursor-pointer' onClick={() => { setIsShowChatBox(false) }}>
      ...
      <div className='flex-fill'>
        {
          isLoading ? (
            ...
            <iframe title='chat' className='w-100 h-100' src={links.find(x => x.key === LINK_KEYS.CHAT_IFRAME.key)?.url} frameborder="0"></iframe>
          )
        }
      </div>
    </div>
